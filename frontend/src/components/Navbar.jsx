                    ...
                    <div className="hidden sm:block" ref={searchRef}>
                        <form onSubmit={handleSearchSubmit} className="relative group">
                            ...
                            <input
                                ...
                                className={`w-48 lg:w-64 pl-10 ${isSearching ? 'pr-10' : 'pr-3'} py-2 rounded-xl text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#007BFF]/30 focus:shadow-lg ${isDark
                                    ...
                                    {isSearching ? (
                                        ...
                                        <>
                                            {searchResults.map((event, index) => (
                                                ...
                                                >
                                                    <div className={`w-10 h-10 rounded-lg flex-shrink-0 mr-3 flex items-center justify-center text-xs font-bold ${event.category === 'cultural'
                                                        ...
                                                        {event.title ? event.title.charAt(0) : 'F'}
                                                    </div>
                            ...
                            {isSearchDropdownOpen && !isSearching && searchResults.length === 0 && searchQuery.trim().length >= 2 && (
                                <div className={`absolute top-full left-0 right-0 mt-2 rounded-2xl shadow-2xl border backdrop-blur-md z-50 ${isDark
                                    ...
                                    <div className="p-4 text-center">
                                        ...
                                        <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                                            No fests found for "{searchQuery}"
                                        </p>
                                    </div>
                                </div>
                            )}
