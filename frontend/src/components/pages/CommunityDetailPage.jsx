...
function TrekCard({ trek, isDark, isFav, onFav, onClick }) {
    return (
        <div
            className="flex-shrink-0 flex flex-col w-40 cursor-pointer active:scale-95 transition-transform"
            onClick={onClick}
        >
            ...
            <div className="flex items-start justify-between mt-2">
                ...
                <button className={`size-8 flex-shrink-0 rounded-2xl flex items-center justify-center mt-0.5 ${isDark ? 'bg-gray-800' : 'bg-white shadow-sm'}`}>
...
export default function CommunityDetailPage() {
    ...
    return (
        <div className={`flex flex-col min-h-screen ${isDark ? 'bg-[#161718]' : 'bg-[#EDEDF2]'}`}>
            ...
            <div className="relative w-full h-[396px] flex-shrink-0">
                {image ? (
                    <img
            ...
            <div className={`relative -mt-10 flex-1 rounded-t-3xl px-4 pt-5 pb-24
                ...
                <div className="flex items-start justify-between mb-1">
                    ...
                    <button
                        onClick={handleShare}
                        className={`size-8 flex-shrink-0 rounded-full flex items-center justify-center mt-1
                                ...
                                {categoryOptions.map(option => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`flex-shrink-0 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 active:scale-95
                                                ${isActive
