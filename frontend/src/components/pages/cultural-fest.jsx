                                            ...
                                            return (
                                                <div key={fest._id}
                                                    ...
                                                    <div className="relative w-full h-[175px] overflow-hidden">
                                                        ...
                                                        <button
                                                            onClick={e => { e.stopPropagation(); toggleFavorite(fest._id, fest); }}
                                                            ...
                                                            <svg width="14" height="14" viewBox="0 0 24 24"
                                                                fill={isFavorite(fest._id) ? '#ef4444' : 'none'}
                                                                stroke={isFavorite(fest._id) ? '#ef4444' : (isDark ? 'white' : '#374151')} strokeWidth="2">
                                                    ...
                                                    <div className="px-4 pt-3 pb-4">
                                                        <p className={`text-lg font-medium leading-7 tracking-wide line-clamp-1 ${isDark ? 'text-white' : 'text-gray-900'}`}>{fest.festName}</p>
                                                        <p className={`text-sm font-medium leading-5 tracking-tight mb-3 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>{fest.collegeName}</p>
                                                        <button
                                        ...
                                        return (
                                            <div key={fest._id}
                                                ...
                                                <div className="relative size-40 shrink-0">
                                                    ...
                                                    <button
                                                        ...
                                                        <svg width="12" height="12" viewBox="0 0 24 24"
                                                            fill={isFavorite(fest._id) ? '#ef4444' : 'none'}
                                                            stroke={isFavorite(fest._id) ? '#ef4444' : 'white'} strokeWidth="2">
                                                            <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
                                                        </svg>
                                                    </button>
                                                </div>
                                                ...
                                                <div className="flex-1 min-w-0 px-4 py-4">
                                                    <p className={`text-sm font-medium leading-5 tracking-tight line-clamp-2 mb-1 ${isDark ? 'text-white' : 'text-gray-900'}`}>{fest.festName}</p>
                                                    <p className={`text-xs font-medium leading-4 tracking-tight line-clamp-1 mb-2 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>{fest.collegeName}</p>
                                                    {fest.festDate && (
