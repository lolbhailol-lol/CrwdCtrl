...
export default function TheatreFormModal({ show, onClose, onSaved }) {
    ...
    const inp = "w-full bg-[#2A2B2D] border border-gray-600 rounded-lg px-4 py-2.5 text-white text-sm focus:outline-none focus:border-[#0ECCEE]";

    return (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/60 py-8 px-4">
            <div className="w-full max-w-2xl bg-[#1B1C1E] rounded-xl border border-gray-700 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <label className="flex items-center gap-2 cursor-pointer w-fit bg-[#2A2B2D] border border-dashed border-gray-500 hover:border-[#0ECCEE] rounded-lg px-4 py-2 text-sm text-gray-400 transition-colors">
