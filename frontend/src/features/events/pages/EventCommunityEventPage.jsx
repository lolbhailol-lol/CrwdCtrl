                            ...
                            <div key={i} className="relative shrink-0 w-full h-full snap-start bg-[#1A1B1D]">
                                {img ? (
                                    <>
                                        ...
                                        alt={event.title}
                                        className={`absolute inset-0 w-full h-full object-contain object-center content-image pointer-events-none select-none ${
                            ...
                            return (
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        if (isPendingReg) {
                                            navigate(`/registration-details/${regId}?type=sports&hub=events`);
                                            return;
                                        }
                                        navigate(`/qr-ticket/${regId}?type=sports&hub=events`);
                                    }}
