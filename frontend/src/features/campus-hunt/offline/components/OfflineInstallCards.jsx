...
export function teamWhatsAppText(row) {
  ...
  return [
    ...
    '2. Wait until Pack saved',
    '3. Tap Download CrwdCtrl Hunt / Install app (name it Hunt — not CrwdCtrl)',
    '4. Open Hunt → password → The Hunt',
    '   Re-open this same link later on Wi‑Fi to get the latest pack + app updates.',
    '   If it opens CrwdCtrl by mistake — delete that shortcut and install Hunt again.',
    '',
