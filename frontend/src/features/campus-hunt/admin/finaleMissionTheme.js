export const FINALE_MISSIONS = [
  ...
  },
  {
    ...
    short: 'Clue → terminal · bring GRID code',
    detail: 'Clue image first (no laptop spoiler on phone). Terminal link + device key → Zip Grid L1 25 / L2 50 / L3 50 · Hint −20 · miss timer keeps earlier points · GRID code on phone (up to 125). Ops: phones banned on the grid page.',
    colorName: 'Blue',
    hex: '#3B82F6',
