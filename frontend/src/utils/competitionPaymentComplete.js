 ...
 */
export async function payAndRegisterCompetition(competitionId, verifiedFields, token) {
...
export async function finalizeCompetitionAfterPayment({
    ...
    const regId = await payAndRegisterCompetition(competitionId, verifiedFields, token);
