...
router.post('/sport/:sportEventId/checkin', sportScannerAuth, sportScannerCheckin);
...
router.post('/trek/:trekId/checkin', trekScannerAuth, trekScannerCheckin);
...
router.post('/:festId/checkin', scannerAuth, scannerCheckin);
