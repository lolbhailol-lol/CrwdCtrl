...
const TREK_SELECT = 'trekName city trekDate dateLabel meetingLocation status maxParticipants trekBatches registration communityId coverImage coverImages images';
