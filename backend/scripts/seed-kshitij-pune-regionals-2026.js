...
const competitions = [
  ...
  },
  {
    ...
    commonRules: ['Performance duration: 2-3 minutes.', 'Props are allowed.', 'Costumes are mandatory.', 'Only Bollywood and Hindi album songs are allowed.', 'Voice-overs are allowed.', 'Use of the theme is compulsory.'],
    judgingCriteria: [],
